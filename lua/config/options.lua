...
-- Temps d'attente (optimisés pour la performance)
vim.opt.updatetime = 100 -- Plus rapide pour LSP et diagnostics (250→100)
vim.opt.timeoutlen = 200 -- Mappings plus réactifs (300→200)

-- Performance supplémentaire
vim.opt.lazyredraw = true -- Ne pas redraw pendant les macros/scripts
vim.opt.synmaxcol = 200   -- Limite la syntaxe sur lignes très longues
vim.opt.regexpengine = 0  -- Moteur regex automatique (plus rapide)
...
-- Désactiver tous les providers non essentiels pour maximiser les performances
vim.g.loaded_ruby_provider = 0
vim.g.loaded_perl_provider = 0
vim.g.loaded_python_provider = 0 -- Python 2
vim.g.loaded_node_provider = 0   -- Node.js (désactiver si non utilisé)

-- Plugins intégrés non essentiels à désactiver
vim.g.loaded_gzip = 1
vim.g.loaded_zip = 1
...
vim.g.loaded_netrw = 1       -- Déjà présent
vim.g.loaded_netrwPlugin = 1 -- Déjà présent
